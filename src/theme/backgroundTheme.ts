export type BackgroundTheme = "black" | "grey" | "blue" | "chrome";

export const BACKGROUND_THEME_STORAGE_KEY = "coda2-bg-theme";

export const DEFAULT_BACKGROUND_THEME: BackgroundTheme = "chrome";
...
export const BACKGROUND_THEME_OPTIONS: Array<{
  ...
  { id: "chrome", label: "Chrome", swatch: "#060b14" },
